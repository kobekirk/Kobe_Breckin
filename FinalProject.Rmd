---
title: "NFL Offensive Strategy Effectiveness"
output: 
  flexdashboard::flex_dashboard:
    logo: "~/Kobe_Breckin/images/logo1.png"
    theme: cerulean
    orientation: rows
...
# displays the NFL logo in the About page
...
```{r, echo = FALSE}
# colors each team by their main team color
nfl_colors <- c(
...
# vector of years in the dataset
year1 <- c(2020, 2021, 2022, 2023, 2024)
# allows user to choose a metric for the x-axis of graph
selectInput(
  "metric",
...
# allows user to select a specific year
selectInput(
  "year1",
  "Select a year:",
  choices  = year1,
...
# makes a reactive bar chart by team
renderPlot({
